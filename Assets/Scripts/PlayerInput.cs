...
public class @PlayerInput : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""PlayerMain"",
            ""id"": ""4da35987-78ca-4f6b-aeb7-f80be66ba970"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""PassThrough"",
                    ""id"": ""d63c7af5-6f01-4d97-979e-64f136b19005"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""8373d7cc-3918-40c8-b6d9-308e0d79c2b3"",
                ...
                },
                {
                    ""name"": ""Dash"",
                    ""type"": ""Button"",
                    ""id"": ""4fb9c79a-5676-4e1f-b95d-3364854fcce7"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""25259b79-3729-408e-b5b0-39b7a441daa6"",
                ...
                {
                    ""name"": """",
                    ""id"": ""b95a4080-3a76-4b60-887e-a675005973ed"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""d7a5cb36-adf4-45e5-814e-c9b4e3327d32"",
                ...
                {
                    ""name"": """",
                    ""id"": ""60d95fdc-3982-4f0b-a64b-ba4b44f8c8bc"",
                ...
                {
                    ""name"": ""AD"",
                    ""id"": ""902d912d-de5b-4ee7-907c-6ccfb2b979e4"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""57f86d20-1b35-43d0-b674-1f44b65922e9"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""10fbe0f3-984e-41af-b3fc-374508d7cb98"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Buttons"",
                    ""id"": ""9cc2947d-91db-4ca6-9405-90c1afb69731"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""486f916a-d90c-456c-b5e0-975aeb965a0e"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""b74fccf1-77dd-4e02-8e36-278ebdba344e"",
